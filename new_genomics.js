...
var caseSetIds = ["paac_jhu_2014_all","laml_tcga_pub_all","laml_tcga_all","acyc_mskcc_all","acc_tcga_all","blca_mskcc_solit_2014_all","blca_mskcc_solit_2012_all","blca_mskcc_signet_ring_impact_all","blca_plasmacytoid_mskcc_2016_all","blca_bgi_all","blca_dfarber_mskcc_2014_all","blca_tcga_pub_all","blca_tcga_all","lgg_tcga_all","brca_bccrc_all","brca_broad_all","brca_sanger_all","brca_tcga_pub_2015_all","brca_tcga_pub_all","brca_tcga_all","brca_bccrc_xenograft_2014_all","cellline_ccle_broad_all","cesc_tcga_all","chol_nccs_2013_all","chol_nus_2012_all","chol_tcga_all","ccrcc_utokyo_2013_all","coadread_genentech_all","coadread_tcga_pub_all","coadread_tcga_all","coadread_mskcc_all","cscc_dfarber_2015_all","desm_broad_2015_all","esca_broad_all","esca_tcga_all","escc_icgc_all","escc_ucla_2014_all","es_iocurie_2014_all","gbc_shanghai_2014_all","egc_tmucih_2015_all","gbm_tcga_pub_2013_all","gbm_tcga_pub_all","gbm_tcga_all","hnsc_broad_all","hnsc_jhu_all","hnsc_tcga_pub_all","hnsc_tcga_all","all_stjude_2015_all","chol_jhu_2013_all","kich_tcga_pub_all","kich_tcga_all","kirc_bgi_all","kirc_tcga_pub_all","kirc_tcga_all","kirp_tcga_all","lihc_amc_prv_all","lihc_riken_all","lihc_tcga_all","lgg_ucsf_2014_all","luad_broad_all","luad_mskcc_2015_all","luad_tcga_pub_all","luad_tcga_all","luad_tsp_all","lusc_tcga_pub_all","lusc_tcga_all","dlbc_tcga_all","mpnst_mskcc_all","mbl_broad_2012_all","mbl_icgc_all","mbl_pcgp_all","skcm_broad_dfarber_all","lgggbm_tcga_pub_all","meso_tcga_all","prad_su2c_2015_all","mm_broad_all","ccrcc_irc_2014_all","cellline_nci60_all","npc_nusingapore_all","nbl_amc_2012_all","nepc_wcm_all","ov_tcga_pub_all","ov_tcga_all","paad_icgc_all","paad_tcga_all","paad_utsw_2015_all","panet_jhu_2011","thca_tcga_pub_all","es_dfarber_broad_2014_all","pcpg_tcga_all","thyroid_mskcc_2016_all","pcnsl_mayo_2015_all","prad_broad_2013_all","prad_broad","prad_mskcc","prad_fhcrc","prad_tcga_pub_all","prad_tcga","prad_mskcc_2014_all","prad_mskcc_cheny1_organoids_2014_all","prad_mich_all","nccrcc_genentech_2014_all","rms_nih_2014_all","sarc_mskcc_all","sarc_tcga_all","skcm_broad_all","skcm_tcga_all","skcm_yale_all","scco_mskcc_all","sclc_clcgp_all","sclc_jhu_all","sclc_ucologne_2015_all","stad_pfizer_uhongkong_all","stad_tcga_pub_all","stad_tcga_all","stad_utokyo_all","stad_uhongkong_all","tgct_tcga_all","tet_nci_2014_all","thym_tcga_all","thca_tcga_all","ucs_jhu_2014_all","ucs_tcga_all","ucec_tcga_all","ucec_tcga_pub_all","uvm_tcga_all"];
  	...
  	if (geneName=="")  
		updateNodeColors(); 
  		...
  		for (var p=0;p<profileIds.length;p++){  
			...
			for (var i=0;i<caseSetIds.length;i++){  
				...
				var casesetid = caseSetIds[i];
				var request = "cmd=getClinicalData&case_set_id="+casesetid//"_all&genetic_profile_id="+study+profile+"&gene_list="+geneName;
				console.log(request); 
